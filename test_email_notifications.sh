...
if echo "$LOGIN_RESPONSE" | grep -q '"success":true'; then
  ...
  echo "  -d '{"
  echo '    "email": "admin@echomeddx.com",'
  ...
  echo "PGPASSWORD=postgres psql -h localhost -U postgres -d echomeddx -c \\"
  echo "  \"UPDATE users SET role = 'super_admin', \\\"emailVerified\\\" = true WHERE email = 'admin@echomeddx.com';\""
  echo ""
  ...
  echo "  VALUES ('admin@echomeddx.com', '\$2b\$10\$7Z9Xr8K5L2M3N4P5Q6R7S.T8U9V0W1X2Y3Z4A5B6C7D8E9F0G1H2I3', 'Super', 'Admin', '+1234567890', 'super_admin', true);\""
  echo ""
  exit 1
fi
