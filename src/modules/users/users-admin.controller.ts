...
export class UsersAdminController {
  ...
  @Get('all-with-plans')
  @ApiOperation({
    summary: 'Get all users with plan info (Admin)',
    description: 'Get all users with their subscription plan information',
  })
  @ApiResponse({
    status: 200,
    description: 'List of users with plan info',
  })
  async getAllUsersWithPlans(@Query() filter: UserFilterDto) {
    return this.usersService.findAllWithPlans(filter);
  }
