...
export class StorageAdminController {
  ...
  @ApiOperation({
    ...
    description: 'Retorna la lista de proveedores con su estado de configuración',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description: 'Retorna la configuración del proveedor especificado (sin datos sensibles)',
  })
  @ApiParam({
    name: 'provider',
  ...
  @ApiOperation({
    ...
    description: 'Valida que la configuración del proveedor es correcta y puede conectarse',
  })
  @ApiParam({
    name: 'provider',
    enum: StorageProviderType,
